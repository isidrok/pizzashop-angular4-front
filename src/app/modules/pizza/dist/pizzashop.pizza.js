...
import { BaseHttpService, PizzashopCoreModule } from 'pizzashop';
...
var PizzaService = (_dec$3 = Injectable(), _dec$3(_class$3 = function (_BaseHttpService) {
  ...
  return PizzaService;
}(BaseHttpService)) || _class$3);
Reflect.defineMetadata('design:paramtypes', [HttpClient], PizzaService);
...
var PizzaComponent = (_dec$2 = Component({
  selector: 'ps-pizza',
  template: html
...
var PizzaRoutingModule = (_dec$1 = NgModule({
...
var PizzaCardComponent = (_dec$4 = Component({
  selector: 'ps-pizza-card',
  template: html$1
}), _dec2 = Input(), _dec$4(_class$4 = (_class2 = function PizzaCardComponent() {
...
var PizzaModule = (_dec = NgModule({
  imports: [PizzashopCoreModule, PizzaRoutingModule],
...
export { PizzaModule };
//# sourceMappingURL=pizzashop.pizza.js.map
